...
const WhyUseDaktarBari = () => {
  return (
    <div className=" lg:mt-32">
      <h1 className="text-black text-2xl lg:text-5xl lg:text-left text-center  lg:ml-20 ">
        Why use Daktar Bari
      </h1>
      {/* hero section */}
      <div className="hero flex justify-center items-center  ">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <img src={medicine} className="  w-7/12 lg:p-8 mt-4 lg:mt-0" />
          <div className="w-100 p-8">
            <ul className="steps steps-vertical">
              <li className="step step-primary my-2 lg:my-6  font-normal text-md">
